...
-- #########################################################################################################
-- Safe call
--  calls a function if existent with args
-- #########################################################################################################
...
-- #########################################################################################################
-- Tick call
--  calls a function with args at a certain tick rate (dependent on the update tickrate/script delta)
-- #########################################################################################################
function Util:tick(tickflag,tickrate,func,...)
	if tickflag >= tickrate then
		func(unpack(arg))
		tickflag = 1
	else
		tickflag = tickflag + 1
